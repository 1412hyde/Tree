...
class TripaAdvisorSpider(Spider):
    ...
    def parse(self, response):
        ...
        # Access next topic list page

        urls = sel.xpath('//div[@id="pager_top2"]/a[@class="guiArw sprite-pageNext"]/@href').extract()
        ...
        #     url = "https://www.tripadvisor.com/ShowForum-g186338-i17-o" + str(page) + "-London_England.html"
        #     yield Request(url, callback=self.parse)
