...
class TripadvisorPipeline(object):
    ...
    def __init__(self):
        ...
        self.fileForum = codecs.open('TripAdvisor_ForumData_Part_5.csv', mode='wb', encoding='utf-8')
        self.fileUserInfo = codecs.open('TripAdvisor_UserInfo_Part_5.csv', mode='wb', encoding='utf-8')
        line1 = csv.writer(self.fileForum)
        line2 = csv.writer(self.fileUserInfo)
        line1.writerow(['forum_topiwc_id','forum_topic_url','forum_topic_name','forum_topic_author','forum_topic_time','forum_locate_id','forum_topic_text'])
